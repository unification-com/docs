...
### Notes on autogenerated `und` commands

Currently an issue with building, in which all text beginning with `<` is interpreted as a HTML tag/Vue component.
To fix, run:

```bash
cd src/mainchain/software/und_cmd
