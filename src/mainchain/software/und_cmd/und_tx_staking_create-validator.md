...
```
und tx staking create-validator [path/to/validator.json] [flags]
```

### Examples

```
$ und tx staking create-validator path/to/validator.json --from keyname
...
where we can get the pubkey using "und tendermint show-validator"
```
