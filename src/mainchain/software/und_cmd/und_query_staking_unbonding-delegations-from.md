## und query staking unbonding-delegations-from
...
Example:
$ und query staking unbonding-delegations-from undvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
und query staking unbonding-delegations-from [validator-addr] [flags]
```
