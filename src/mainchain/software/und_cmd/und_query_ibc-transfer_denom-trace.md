## und query ibc-transfer denom-trace
...
```
und query ibc-transfer denom-trace [hash/denom] [flags]
```

### Examples

```
und query ibc-transfer denom-trace 27A6394C3F9FF9C9DCF5DFFADF9BB5FE9A37C7E92B006199894CF1824DF9AC7C
```
