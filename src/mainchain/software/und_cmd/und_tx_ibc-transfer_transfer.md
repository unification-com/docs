...
```
und tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount] [flags]
```

### Examples

```
und tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount]
```
