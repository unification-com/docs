## und query staking redelegations-from
...
Example:
$ und query staking redelegations-from undvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
und query staking redelegations-from [validator-addr] [flags]
```
