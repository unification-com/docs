...
```
und tx bank multi-send [from_key_or_address] [to_address_1 to_address_2 ...] [amount] [flags]
```

### Examples

```
und tx bank multi-send cosmos1... cosmos1... cosmos1... cosmos1... 10stake
```
