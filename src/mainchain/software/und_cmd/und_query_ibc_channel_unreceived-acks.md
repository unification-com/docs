## und query ibc channel unreceived-acks
...
```
und query ibc channel unreceived-acks [port-id] [channel-id] [flags]
```

### Examples

```
und query ibc channel unreceived-acks [port-id] [channel-id] --sequences=1,2,3
```
