## und tx ibc channel prune-acknowledgements
...
```
und tx ibc channel prune-acknowledgements [port] [channel] [limit] [flags]
```

### Examples

```
und tx ibc channel prune-acknowledgements transfer channel-0 1000
```
