## und tx gov submit-legacy-proposal param-change
...
Example:
$ und tx gov submit-proposal param-change &lt;path/to/proposal.json&gt; --from=&lt;key_or_address&gt;
...
```
und tx gov submit-legacy-proposal param-change [proposal-file] [flags]
```
