...
```
und tx ibc client update [client-id] [path/to/client_msg.json] [flags]
```

### Examples

```
und tx ibc client update [client-id] [path/to/client_msg.json] --from node0 --home ../node0/&lt;app&gt;cli --chain-id $CID
```
