## und query ibc-fee total-recv-fees
...
```
und query ibc-fee total-recv-fees [port-id] [channel-id] [sequence] [flags]
```

### Examples

```
und query ibc-fee total-recv-fees transfer channel-5 100
```
