...
$ und query authz grants cosmos1skjw.. cosmos1skjwj.. /cosmos.bank.v1beta1.MsgSend

```
und query authz grants [granter-addr] [grantee-addr] [msg-type-url]? [flags]
```
