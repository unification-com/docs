## und tx ibc channel upgrade-channels
...
```
und tx ibc channel upgrade-channels [flags]
```

### Examples

```
und tx ibc channel upgrade-channels "{\"fee_version\":\"ics29-1\",\"app_version\":\"ics20-1\"}" --deposit 10stake
```
