## und query ibc channel next-sequence-send
...
```
und query ibc channel next-sequence-send [port-id] [channel-id] [flags]
```

### Examples

```
und query ibc channel next-sequence-send [port-id] [channel-id]
```
