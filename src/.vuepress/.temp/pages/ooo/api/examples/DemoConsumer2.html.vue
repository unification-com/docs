...
<ul>
<li><a href="#DemoConsumer2-constructor-address-address-address-uint256-"><code v-pre>constructor(address _router, address _xfund, address _provider, uint256 _fee) public</code></a></li>
<li><a href="#DemoConsumer2-setProvider-address-"><code v-pre>setProvider(address _provider) external</code></a></li>
<li><a href="#DemoConsumer2-setFee-uint256-"><code v-pre>setFee(uint256 _fee) external</code></a></li>
<li><a href="#DemoConsumer2-requestData-bytes32-string-"><code v-pre>requestData(bytes32 _data, string pair) external</code></a></li>
<li><a href="#DemoConsumer2-getPrice-string-"><code v-pre>getPrice(string pair) external</code></a></li>
<li><a href="#DemoConsumer2-increaseRouterAllowance-uint256-"><code v-pre>increaseRouterAllowance(uint256 _amount) external</code></a></li>
<li><a href="#DemoConsumer2-setRouter-address-"><code v-pre>setRouter(address _router) external</code></a></li>
<li><a href="#DemoConsumer2-withdrawxFund-address-uint256-"><code v-pre>withdrawxFund(address _to, uint256 _value) external</code></a></li>
<li><a href="#DemoConsumer2-receiveData-uint256-bytes32-"><code v-pre>receiveData(uint256 _price, bytes32 _requestId) internal</code></a></li>
</ul>
<p><a name="DemoConsumer2-constructor-address-address-address-uint256-"></a></p>
...
<a name="DemoConsumer2-setProvider-address-"></a></p>
</li>
</ul>
...
<a name="DemoConsumer2-setFee-uint256-"></a></li>
</ul>
...
<a name="DemoConsumer2-requestData-bytes32-string-"></a></li>
</ul>
<h3 id="function-requestdata-bytes32-data-string-pair-external" tabindex="-1"><a class="header-anchor" href="#function-requestdata-bytes32-data-string-pair-external" aria-hidden="true">#</a> Function <code v-pre>requestData(bytes32 _data, string pair) external </code></h3>
...
<a name="DemoConsumer2-getPrice-string-"></a></li>
</ul>
<h3 id="function-getprice-string-pair-external-uint256" tabindex="-1"><a class="header-anchor" href="#function-getprice-string-pair-external-uint256" aria-hidden="true">#</a> Function <code v-pre>getPrice(string pair) external  -&gt; uint256</code></h3>
<p>getPrice returns the current price</p>
<h4 id="return-values" tabindex="-1"><a class="header-anchor" href="#return-values" aria-hidden="true">#</a> Return Values:</h4>
<ul>
<li>price uint256
<a name="DemoConsumer2-increaseRouterAllowance-uint256-"></a></li>
</ul>
...
<a name="DemoConsumer2-setRouter-address-"></a></li>
</ul>
...
<a name="DemoConsumer2-withdrawxFund-address-uint256-"></a></li>
</ul>
...
<a name="DemoConsumer2-receiveData-uint256-bytes32-"></a></p>
</li>
</ul>
